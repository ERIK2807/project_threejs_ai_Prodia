...
export default function Headers() {
  return (
    <>
{/* <nav classNameName="flex sm:justify-center space-x-4">
    {[
        ['Inicio', '/dashboard'],
        ['Galeria', '/team'],
        ['Perfil', '/projects'],
        ['Mis creaciones', '/reports'],
        ['Mis compras', '/reports'],
        ['Favoritos', '/reports'],
    ].map(([title, url]) => (
        <a href={url} classNameName="rounded-lg px-3 py-2 text-slate-700 font-medium hover:bg-slate-100 hover:text-slate-900">{title}</a>
    ))}
    </nav> */}
